...
describe('Auth Service', () => {
  ...
  describe('constructor()', () => {
    it('should be initialized', inject(
      [AuthService, ErrorDisplayService, Router],
      (service: AuthService) => {
  ...
  describe('logout()', () => {
    it( `should clear the 'token key' and 'name key' from local ` +
        `storage and redirect the user to the login page`, inject(
      [AuthService, ErrorDisplayService, Router],
      (service: AuthService) => {
  ...
  describe('_authenticate()', () => {
    ...
    it( `should save the token and the firstname in localstorage ` +
        `if the server does return a token`, inject(
      [AuthService, ErrorDisplayService, Router],
      (service: AuthService) => {
        let spy  = spyOn(service['router'], 'navigate');
